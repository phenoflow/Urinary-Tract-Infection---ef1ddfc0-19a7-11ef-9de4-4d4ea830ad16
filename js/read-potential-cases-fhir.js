...
(async () => {
  ...
  await fs.writeFile("urinary-tract-infection-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("urinary-tract-infection-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
